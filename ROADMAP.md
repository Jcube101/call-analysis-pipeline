...
- [ ] **Stream Stage 3 audio slices** — `transcribe.py` still loads the whole clean WAV into memory; the last remaining ceiling on recording length (see [KNOWN-ISSUES.md](KNOWN-ISSUES.md))
